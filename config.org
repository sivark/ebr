...
#+begin_src emacs-lisp
  (use-package lambda-themes
    :ensure t (:host github :repo "lambda-emacs/lambda-themes") 
    :custom
...
:ensure t (:host github :repo "rougier/org-margin")
;:config
;(org-margin-mode 1)
)
#+end_src
...
;    :ensure t (:host github :repo "thongpv87/rose-pine-emacs"))
#+end_src
...
#+begin_src emacs-lisp
  ...
  ; (elpaca-wait)
    (use-package perspective-tabs
      :after (perspective)
      :ensure t (:host sourcehut :repo "woozong/perspective-tabs")
      :init
...
#+begin_src emacs-lisp
    (use-package tabspaces
      :ensure t (:type git :host github :repo "mclear-tools/tabspaces")
...
#+begin_src emacs-lisp
  ...
  ;;   :ensure t (:host github :repo "integral-dw/org-superstar-mode")
  ;;   ;;:config
  ;;   ;;(org-superstar-mode 1))
  ;; )
...
#+begin_src emacs-lisp
  (use-package ekg
    :ensure t (:host github :repo "ahyatt/ekg")
    :config
...
#+begin_src emacs-lisp
  (use-package apheleia
    :ensure t (:host github :repo "radian-software/apheleia")
    :config
...
#+begin_src emacs-lisp
  (use-package ctrlf
    :ensure t (:host github :repo "radian-software/ctrlf")
    :config
    (ctrlf-mode +1))
#+end_src
...
#+begin_src emacs-lisp
  (use-package org-newtab
    :ensure t (:host github :repo "Zweihander-Main/org-newtab"))
#+end_src

** Things to explore/add
- Treesitter
- Combobulate
- Corfu
...
#+begin_src emacs-lisp
  ...
  (use-package calibredb
    :defer t
    :config
    (setq calibredb-root-dir "/mnt/misc/CalibreLibrary")
    (setq calibredb-db-dir (expand-file-name "metadata.db" calibredb-root-dir))
    (setq calibredb-library-alist '(("/mnt/misc/CalibreLibrary"))))
...
#+begin_src
  (use-package doct
  :ensure t (:host github :repo "progfolio/doct")
  :defer t)
  (setq org-capture-templates (doct '(("journal" :keys "j"
					 :file "~/org/journal.org"
					 :datetree t
					 :children (("Store-link"  :keys "s"
						     :template ("* %U %a :NYXT: \n%?")
						     :hook (lambda ()
							     (message "Captured URL."))
						     :immediate-finish t)
						    ("Interaction"  :keys "i"
						     :template ("* %U %^{Person/Meeting} :INTERACTION:")
						     :hook (lambda ()
							     (message "\"Recorded interaction.")))
						    ("Note"  :keys "n"
						     :template ("* %U %^{Description} :NOTE:")
						     :hook (lambda ()
							     (message "\"Recorded note.")))))
					("browser-bookmarks" :keys "b"
					 :file "~/org/browser-bookmarks.org"
					 :datetree nil))))
#+end_src
  ...
  (setq org-capture-templates
	'(("t" "Todo" entry (file+headline "~/org/gtd.org" "Tasks")
	  ...
	  ("j" "Journal" entry (file+datetree "~/org/journal.org")
	   "* %?\nEntered on %U\n  %i\n  %a")
	  ("b" "Bookmark"
	   entry (file+headline "~/org/browser-bookmarks.org" "Bookmarks")
	   "* [[%^{link-url}][%^{link-description}]]")
	  ("p" "Protocol" entry (file+headline ,(concat org-directory "browser-bookmarks.org") "Inbox")
	   "* %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n%?")
	  ("L" "Protocol Link" entry (file+headline "~/org/browser-bookmarks.org" "Inbox")
	   "* %:link \n%:description \nCaptured at %U"
	   :immediate-finish t)))
#+end_src

* Spell check with the Jinx package

#+begin_src emacs-lisp
  (use-package jinx
    :ensure t (:host github :repo "minad/jinx")
    :defer t
    )
#+end_src
...
#+begin_src emacs-lisp
  (use-package gruvbox-theme
    :ensure t (:host github :repo "greduan/emacs-theme-gruvbox")
    :defer t)

  (use-package kanagawa-theme
    :ensure t (:host github :repo "Fabiokleis/emacs-kanagawa-theme")
    :defer t)
#+end_src
